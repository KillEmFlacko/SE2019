...
/**
 * A single game level with his entities and map. A lavel is a Group, which
 ...
 * entities. Knows how to start and when has ended.
 *
 * @author Davide
 */
public abstract class Level extends Group {
     ...
     * target?)
     */
    public class EndLevelEvent extends ChangeListener.ChangeEvent {
